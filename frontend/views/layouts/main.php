...
<head>
    <meta charset="utf-8">
    <title>IT ТЕХНОЛОГИИ ДЛЯ БИЗНЕСА| SMART-DIGITAL</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="page-scroll" href="#top">Главная</a>
                        </li>
                        <li><a class="page-scroll" href="#services">Услуги</a>
                        </li>
                        <li><a class="page-scroll" href="#portfolio">Проекты</a>
                        </li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="footer-content text-right">
                        <p>&copy; 2015 All Rights Reserved, <a href="http://smart-digital.com.ua/">Smart-Digital</a>
                        </p>
                    </div>
                </div>
                <!-- END FOOTER CONTENT -->
